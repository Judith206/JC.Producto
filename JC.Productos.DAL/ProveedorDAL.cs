...
namespace JC.Productos.DAL
{
    public class ProveedorDAL
    {
        ...
        public ProveedorDAL(ProductoDBContext productoDB)
        {
        ...
        public async Task<Proveedor> ObtenerPorIdAsync(Proveedor pProveedor)
        {
            ...
            if (proveedor != null && proveedor.Id != 0)
            {
                return new Proveedor
                {
                    ...
                    Email = proveedor.Email// en teoria deberia de ir pProveedor porque asi esta en el documento si no me da eeror fue una trampa y si no 
                };
            }
            else
                return new Proveedor();
