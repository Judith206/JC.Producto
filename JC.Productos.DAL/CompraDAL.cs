...
namespace JC.Productos.DAL
{
    public class CompraDAL
    {
        ...
        public CompraDAL(ProductoDBContext ProductoDB)
        {
        ...
        public async Task<int> AnularAsync(int idCompra)
        {
            ...
            return 0; //si ya esta anulada, no hacer nada
        }
        ...
        public async Task<List<Compra>> ObtenerReporteComprasAsync(ComprarFiltros filtro)
        {
            ...
            {
                DateTime fechaFin = filtro.FechaFin.Value.Date.AddDays(1).AddSeconds(-1);// Eliminar la hora dejar solo la fecha
