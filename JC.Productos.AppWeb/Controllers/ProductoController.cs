...
namespace JC.Productos.AppWeb.Controllers
{
    public class ProductoController : Controller
    {
        ...
        {
            var proveedores = await _productoBL.ObtenerTodosAsync();
            return new ViewAsPdf("rpProductos", proveedores)
            {
        ...
        public async Task<JsonResult> ProductosJsonPrecio()
        {
            ...
            var groupedData = productosData
                ...
                {
                    fecha = g.Key,
                    precioPromedio = g.Average(p => p.precio)//calcular el promedio
                })
                .OrderBy(g => g.fecha)
                .ToList();
        ...
        public async Task<IActionResult> ReporteProductosExcel()
        {
            ...
            using (var package = new ExcelPackage()) 
            {
                ...
                return File(stream, "application/vnd.openxmlformarts-officedocument.spreadsheet.sheet", "ReporteProductosExel.xlsx");
            }
        }
        [HttpPost]
